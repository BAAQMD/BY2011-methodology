...
```{r chem_fac-pharms-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r chem_fac-pharms-annual_growth-chart}
...
```{r chem_fac-pharms-annual_control-chart}
