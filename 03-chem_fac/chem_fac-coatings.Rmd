...
```{r chem_fac-coatings-annual_emissions-chart, fig.height = 8, out.height = 800}
...
```{r chem_fac-coatings-annual_growth-chart}
...
```{r chem_fac-coatings-annual_control-chart}
