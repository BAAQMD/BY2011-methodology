...
```{r waste_mgmt-landfill-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r waste_mgmt-landfill-annual_growth_factor_data, fig.height=8, out.height=800}
...
```{r waste_mgmt-landfill-annual_control_factor_data, fig.height=6, out.height=600}
