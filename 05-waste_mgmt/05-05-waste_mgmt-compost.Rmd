...
> Emission factors for category #1936 vary by time. (This is not common in the BY2011 inventory.) **Note: #1936 is a point-source category. (?)**

```{r waste_mgmt-compost-emission_factors-chart, fig.height=6, out.height=600}
