## Refinery Process Vessel Depressurization {#petref-fac-vessel_depress}

```{r petref-fac-vessel_depress-setup}
THESE_CATEGORIES <- c(
...
### Trends {#petref-fac-vessel_depress-trend}

#### History {-}

```{r petref-fac-vessel_depress-emission-chart, fig.height=4, out.height=400}
...
```{r petref-fac-vessel_depress-growth-crosswalk}
...
```{r petref-fac-vessel_depress-growth-chart, fig.height=3, out.height=300}
...
```{r petref-fac-vessel_depress-control-chart, fig.height=3, out.height=300}
...
The District adopted [Regulation 8-10] on July 20, 1983. Overall control afforded by this rule is estimated to be 95%.
