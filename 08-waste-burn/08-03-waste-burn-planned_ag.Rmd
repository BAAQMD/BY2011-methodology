## Planned Agricultural Burning {#waste-burn-planned_ag}

```{r waste-burn-planned_ag-setup}
THESE_CATEGORIES <- c(
  "#315 Prunings" = 315,
  "#316 Field Crops" = 316,
...
#### Methodologies {#waste-burn-planned_ag-methodology -}
...
```{r waste-burn-planned_ag-emission-chart, fig.height=12, out.height=1200}
...
```{r waste-burn-planned_ag-growth-chart, fig.height=8, out.height=800}
