...
The ratio of each County's population was used to distribute emission into counties.  (added 6/24) For area source categories, the "American Community Survey" census data was used to derive county fractions.
