...
- **[Comments]** In 1995, there were 352 gasoline service stations (or GDFs) in the Bay Area were equipped with vacuum-assist Phase II vapor recovery systems utilizing Emco Wheaton A4001 bootless nozzles. Due to the dispensing rates, and certain design issues, these Emco bootless nozzles were more prone to spitback, pseudo-spillage, low air to liquid ratio, pressure-related fugitive emissions, idle-nozzle emissions (14.6 tons per day) occurring after refueling.As a result from several meetings between Planning (Jean Roggenkamp), Source Test (Ken Kunaniec), and Special Projects-Emission Inventory (Toch Mangat) sections, this category (Cat#1197) was created in Base Year 1995 to account for excess emissions from gasoline dispensing nozzles at gasoline service stations and “whoosh” emissions. The “whoosh” emissions were the emissions released when the car owners remove the vehicle’s gasoline cap. 

Per Toch Mangat, the bootless nozzles emissions from these gasoline service stations had not occurred prior to 1995. Therefore, backcasted emissions (1990-1994) for this GDF excess emissions were not estimated and assigned as ‘NULL” or (‘-8888’ in Databank).
