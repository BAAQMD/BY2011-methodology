...
- [Cogeneration](#SS-combust-cogen-trends): Estimated CY1990-2007 TOG emissions for category #292 Reciprocating Engines are too low, compared to CH~4~. (The CH~4~/TOG ratio for those years is well above 1, generally in the range of 3x to 30x.) About 1,000 ton/yr TOG and 100 ton/yr ROG may be missing for those years.
...
- [Composting](#waste-mgmt-compost-trends): 
...
- [Lawn & Garden Equipment](#mobile-lawn-garden-trend): N~2~O emissions for a five-year interval (CY2026-2030) are exactly zero.
...
- [Industrial Equipment](#mobile-offroad-diesel-indust-equip)
    - TOG emissions for #1667 (Natural Gas) exhibit the same zero-every-5-years artifact that is present in [Recreational Boats](#mobile-boat-recreations), only this time it is isolated to one pollutant (TOG). 
