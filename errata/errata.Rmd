...
- 10,000 ton/yr of CO emissions stops abruptly at CY1998. Few other point-source categories even approach this magnitude of CO emissions. This is traceable to a single facility. For perspective, all five refineries (all of their categories combined) emit about 2,000 to 4,000 ton/yr CO, and have since CY1990.
...
- Estimated CY1990-2007 TOG emissions for category #292 [Reciprocating Engines](#07-08-SS-combust-engine-recip) are too low, compared to CH~4~. (The CH~4~/TOG ratio for those years is well above 1, generally in the range of 3x to 30x.) About 1,000 ton/yr TOG and 100 ton/yr ROG may be missing for those years.

##### Power Plants {-}

- The CO~2~/CO ratio for CY1990-2000 for [Gas Fired Boilers](#SS-combust-power-boiler-trend) appears to be far too low, given what is observed for subsequent decades. This could be resulting in the absence of 5-10 MMTCO2eq from the CY1990 BAAQMD inventory. An absence of CO~2~ of that magnitude, in CY1990, could be substantially distorting the answer to the key question of whether the District is "on track" to reach its CY2030 target.

- (Possibly related) For [Oil Fired Boilers](#SS-combust-power-boiler-trend), emissions seem to be almost entirely absent from the BY2011 inventory. There are some very small emissions (~ 0.1 ton/yr of TOG and NO~x~) estimated for CY2008-2010, but that is it.
