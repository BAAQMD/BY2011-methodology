...
In 1995, there were 352 gasoline service stations (or GDFs) in the Bay Area were equipped with vacuum-assist Phase II vapor recovery systems utilizing Emco Wheaton A4001 bootless nozzles. Due to the dispensing rates, and certain design issues, these Emco bootless nozzles were more prone to spitback, pseudo-spillage, low air to liquid ratio, pressure-related fugitive emissions, idle-nozzle emissions (14.6 tons per day) occurring after a refueling.
