...
- [General Refinery Emissions](#petref-fac-general-trend): For category #10, BY2011 NO~x~ emissions are much lower than DataBank numbers would indicate. SO~x~ and PM emissions, on the other hand, are consistent. For category #16 "Other", CO~2~ emissions are large (~3 MMTCO2eq) and linearly increasing, which is mildly inconsistent with profiles for other pollutants in this category.
