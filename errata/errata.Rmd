...
- [Land Farming](#waste-mgmt-farm-trend): The growth profile does not seem to match the published emissions for CY1990-1995. Further, the CY1990 emissions for TOG are sharply increased at CY1990. A probable cause: the emission factor for TOG changed abruptly, from CY1990 (TOG = 20 lb/ton) to CY1991 onwards (TOG = 2.24 lb/ton). Although this affects TOG, it is not reflected in published CY1990 emissions of CH~4~.
...
- [Other External Combustion - Natural Gas](#SS-combust-external-NG):
    ...
    - Categories #1590 and #1591 should be double-checked against CEC data. See [10.1 Natural Gas Consumption](https://baaqmd.github.io/charting-annual-data/10-third_party.html#natural-gas-consumption), in the Charting Annual Data cookbook.
