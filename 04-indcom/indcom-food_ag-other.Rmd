...
Carbon dioxide (CO2) emissions are produced during the fermentation process of beer production and in the combustion of organic emissions from coffee and cocoa beans in abatement devices, such as an afterburner. The CO2 emissions emitted from beer production is considered biogenic.
...
```{r indcom-food_ag-other-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r indcom-food_ag-other-annual_growth-chart}
...
```{r indcom-food_ag-other-annual_control-chart}
