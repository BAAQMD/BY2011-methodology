...
```{r indcom-cement-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r indcom-cement-annual_growth-chart, fig.height=12, out.height=1200}
...
```{r indcom-cement-annual_control-chart, fig.height=8, out.height=800}
...
The cement manufacturing operations are subject to District regulations regarding permitting (Regulations 2-1 and 2-2), emissions of toxic or hazardous compounds (Regulation 2-5) and some regulations for individual pollutants. For example, Regulation 6-1 reduces particulate emissions from the control imposed by Ringleman requirements.

The District adopted Regulation 9, Rule 13, Nitrogen Oxide, Particulate Matter, and Toxic Air Contaminants from Portland Cement Manufacturing, on September 17, 2012.

This rule becomes effective on September 9, 2013 and limits the emissions of NOx, PM, and toxic air contaminants.
