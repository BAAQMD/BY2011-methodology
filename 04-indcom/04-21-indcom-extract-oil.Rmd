...
```{r indcom-extract-oil-field-emission-factors-table}
...
```{r indcom-extract-oil-emission-chart, fig.height=6, out.height=600}
...
```{r indcom-extract-oil-growth-chart, fig.height=8, out.height=800}
