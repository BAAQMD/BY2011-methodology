...
```{r indcom-mfg-semicond-emission-chart, fig.height=6, out.height=600}
...
```{r indcom-mfg-semicond-growth-chart, fig.height=8, out.height=800}
...
```{r indcom-mfg-semicond-control-chart}
