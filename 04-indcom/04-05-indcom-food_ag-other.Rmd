...
```{r indcom-food_ag-other-emission-chart, fig.height=14, out.height=1400}
...
```{r indcom-food_ag-other-growth-crosswalk}
...
```{r indcom-food_ag-other-growth-chart, fig.height=3, out.height=300}
...
```{r indcom-food_ag-other-control-chart, fig.height=3, out.height=300}
