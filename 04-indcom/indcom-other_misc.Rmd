...
All seven of the greenhouse gases, namely carbon dioxide (CO2), biogenic CO2, methane (CH4), nitrous oxide (N2O), hydrofluorocarbons (HFC’s), perfluorocarbons (PFC’s), and sulfur hexafluoride (SF6), are also calculated for applicable sources.
...
```{r indcom-other_misc-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r indcom-other_misc-annual_growth-chart}
