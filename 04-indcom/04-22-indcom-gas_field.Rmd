...
```{r indcom-gas_field-emission-chart, fig.height=6, out.height=600}
...
```{r indcom-gas_field-growth-chart, fig.height=8, out.height=800}
...
```{r indcom-gas_field-control-chart}
