## Gas Production Fields {#indcom-gas_field}

```{r indcom-gas_field-setup}
THESE_CATEGORIES <- c(
...
##### Area Sources {- #indcom-gas_field-methodology-area}
...
```{r indcom-gas-field-emission-factors-table}
...
```{r indcom-gas_field-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r indcom-gas_field-annual_growth-chart, fig.height=8, out.height=800}
...
```{r indcom-gas_field-annual_control-chart}
