...
```{r indcom-oil_field-emission-chart, fig.height=6, out.height=600}
...
```{r indcom-oil_field-growth-chart, fig.height=8, out.height=800}
...
```{r indcom-oil_field-control-chart}
