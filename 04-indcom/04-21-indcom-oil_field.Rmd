## Oil Production Fields {#indcom-oil_field}

```{r indcom-oil_field-setup}
THESE_CATEGORIES <- c(
...
##### Area Sources {- #indcom-oil_field-methodology-area}
...
```{r indcom-oil-field-emission-factors-table}
...
```{r indcom-oil_field-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r indcom-oil_field-annual_growth-chart, fig.height=8, out.height=800}
...
```{r indcom-oil_field-annual_control-chart}
