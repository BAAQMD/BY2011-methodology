...
```{r indcom-wineries-fermentation-setup}
THESE_CATEGORIES <- c(
...
#### Methodology {#wineries-fermentation-methodology -}
...
```{r indcom-wineries-fermentation-annual_emissions-chart}
...
```{r indcom-wineries-fermentation-annual_growth-chart}
