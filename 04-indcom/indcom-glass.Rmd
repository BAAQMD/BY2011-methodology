...
```{r indcom-glass-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r indcom-glass-BY_vs_DB-emissions_chart, fig.height=16, out.height=1600}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r indcom-glass-annual_growth-chart}
...
```{r indcom-glass-annual_control-chart}
