...
```{r indcom-stone_sand_gravel-emission-chart, fig.height=8, out.height=800}
...
```{r indcom-stone_sand_gravel-BY-vs-DB-chart, fig.height=12, out.height=1200}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r indcom-stone_sand_gravel-growth-chart}
...
```{r indcom-stone_sand_gravel-control-chart}
