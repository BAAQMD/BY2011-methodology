...
```{r indcom-glass-emission-chart, fig.height=12, out.height=1200}
...
```{r indcom-glass-BY-vs-DB-chart, fig.height=16, out.height=1600}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
