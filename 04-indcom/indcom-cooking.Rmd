...
```{r indcom-cooking-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r indcom-cooking-annual_growth-chart, fig.height=6, out.height=600}
...
```{r indcom-cooking-annual_control-chart}
