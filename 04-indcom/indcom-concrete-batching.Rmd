...
#### History {- #indcom-concrete-batching-history}

```{r indcom-concrete-batching-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r indcom-concrete-batching-BY_vs_DB-emissions_chart, fig.height=10, out.height=1000}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r indcom-concrete-batching-annual_growth-chart}
