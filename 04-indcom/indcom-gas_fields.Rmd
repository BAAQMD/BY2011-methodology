## Gas Production Fields {#indcom-gas_fields}

```{r indcom-gas_fields-setup}
THESE_CATEGORIES <- c(
...
##### Area Sources {- #indcom-gas_fields-methodology-area}
...
```{r indcom-gas_fields-emission_factors-table}
...
```{r indcom-gas_fields-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r indcom-gas_fields-annual_growth-chart, fig.height=8, out.height=800}
...
```{r indcom-gas_fields-annual_control-chart}
