...
```{r petref_fac-fugitive-annual_emissions-chart, fig.height=4, out.height=400}
...
```{r petref_fac-fugitive-annual_growth-chart, fig.height=6, out.height=600}
...
```{r petref_fac-fugitive-annual_control-chart, fig.height=6, out.height=600}
