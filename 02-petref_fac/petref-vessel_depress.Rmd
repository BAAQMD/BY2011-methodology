...
```{r petref_fac-vessel_depress-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r petref_fac-vessel_depress-annual_growth-chart, fig.height=8, out.height=800}
...
```{r petref_fac-vessel_depress-annual_control-chart, fig.height=8, out.height=800}
