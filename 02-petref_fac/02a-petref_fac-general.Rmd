## General Refinery Emissions {#petref_fac-general}

```{r petref_fac-general-setup}
THESE_CATEGORIES <- c(
...
### Trends {#petref_fac-general-trend}

#### History {-}

```{r petref_fac-general-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r petref_fac-general-BY_vs_DB-emissions-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r petref_fac-general-annual_growth-chart, fig.height=12, out.height=1200}
...
```{r petref_fac-general-annual_control-chart, fig.height=8, out.height=800}
