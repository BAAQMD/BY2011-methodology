...
```{r misc-fire-veg-emission-factors-table}
...
```{r misc-fire-veg-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r misc-fire-veg-growth-chart, fig.height=6, out.height=600}
