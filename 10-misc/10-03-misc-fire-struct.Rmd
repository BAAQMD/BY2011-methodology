...
```{r misc-fire-struct-emission-factors-table}
...
```{r misc-fire-struct-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r misc-fire-struct-growth-chart, fig.height=5, out.height=500}
