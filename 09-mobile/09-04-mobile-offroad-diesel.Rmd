...
```{r mobile-offroad-construction-annual_emissions-chart, fig.height=18, out.height=1800}
...
```{r mobile-offroad-diesel-annual_growth-chart}
#
...
```{r mobile-offroad-construct_equip-annual_emissions-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
...
```{r mobile-offroad-indust_equip-annual_emissions-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
...
```{r mobile-offroad-light_com_equip-annual_emissions-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
