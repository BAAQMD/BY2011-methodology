## Transportation Refrigeration Units {#mobile-TRU}
...
### Trends {#mobile-TRU-trend}

#### History {-}

```{r mobile-TRU-emission-chart, fig.height=12, out.height=1200}
...
```{r mobile-TRU-growth-chart, fig.height=8, out.height=800}
