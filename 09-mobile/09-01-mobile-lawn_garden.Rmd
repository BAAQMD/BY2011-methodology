## Lawn and Garden Equipment {#mobile-lawn_garden}

```{r mobile-lawn_garden-setup}
THESE_CATEGORIES <- c(
...
### Trends {#mobile-lawn_garden-trend}

#### History {-}

```{r mobile-lawn_garden-emission-chart, fig.height=12, out.height=1200}
...
```{r mobile-lawn_garden-growth-crosswalk}
...
```{r mobile-lawn_garden-growth-chart, fig.height=8, out.height=800}
