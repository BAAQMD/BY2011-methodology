## Recreational Boats {#mobile-rec_boat}
...
### Trends {#mobile-rec_boat-trend}

#### History {-}

```{r mobile-rec_boat-emission-chart, fig.height=12, out.height=1200}
...
```{r mobile-rec_boat-growth-crosswalk}
...
```{r mobile-rec_boat-growth-chart, fig.height=8, out.height=800}
