...
```{r mobile-ship-emission-chart, fig.height=18, out.height=1800}
...
```{r mobile-ship-container-by_activity-emission-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  filter(
...
```{r mobile-ship-tanker-by_activity-emission-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  filter(
...
```{r mobile-ship-by_engine-emission-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  mutate(
