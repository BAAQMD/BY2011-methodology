## Agricultural Equipment {#mobile-ag-equip}

```{r mobile-ag-equip-setup}
THESE_CATEGORIES <- c(
...
### Trends {#mobile-ag-equip-trend}

#### History {-}

```{r mobile-ag-equip-emission-chart, fig.height=12, out.height=1200}
...
```{r mobile-ag-equip-growth-crosswalk}
...
```{r mobile-ag-equip-growth-chart, fig.height=8, out.height=800}
