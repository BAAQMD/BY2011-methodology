...
```{r mobile-offroad-rec_veh-emission-chart, fig.height=12, out.height=1200}
...
```{r mobile-offroad-rec_veh-growth-crosswalk}
...
```{r mobile-offroad-rec_veh-growth-chart, fig.height=10, out.height=1000}
