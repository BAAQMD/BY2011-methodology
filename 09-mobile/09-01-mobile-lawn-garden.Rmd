## Lawn and Garden Equipment {#mobile-lawn-garden}

```{r mobile-lawn-garden-setup}
THESE_CATEGORIES <- c(
...
### Trends {#mobile-lawn-garden-trend}

#### History {-}

```{r mobile-lawn-garden-emission-chart, fig.height=12, out.height=1200}
...
```{r mobile-lawn-garden-growth-crosswalk}
...
```{r mobile-lawn-garden-growth-chart, fig.height=8, out.height=800}
