...
```{r misc_other-fires-auto-emission_factors-table}
...
Table: Composite criteria-pollutant EFs for automobile fires.
...
Table: Composite greenhouse gas (GHG) EFs for automobile fires.
