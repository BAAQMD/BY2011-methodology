## Accidental Automobile Fires {#misc_other-fires-auto}

```{r misc_other-fires-auto-setup}
THESE_CATEGORIES <- c(
...
#### Methodology {- #misc_other-fires-auto-methodology}
...
```{r misc_other-fires-auto-emission_factors-PONSCO-table}
...
```{r misc_other-fires-auto-emission_factors-GHG-table}
BY2011_annual_area_source_emission_factor_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  kable_BY2011_emission_factors(
...
```{r misc_other-fires-auto-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r misc_other-fires-auto-annual_growth-chart, fig.height=6, out.height=600}
