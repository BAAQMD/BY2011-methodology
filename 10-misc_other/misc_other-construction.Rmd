...
```{r misc_other-construction-setup}
THESE_CATEGORIES <- c(
  "#744 Residential" = 744,
  "#745 Commericial" = 745,
...
```{r misc_other-construction-annual_emissions-chart, fig.height=8, out.height=800}
...
```{r misc_other-construction-annual_growth-chart, fig.height=12, out.height=1200}
