...
```{r misc_other-windblown_dust-setup}
THESE_CATEGORIES <- c(
...
```{r misc_other-windblown_dust-annual_emission-chart, fig.height=6, out.height=600}
...
```{r misc_other-windblown_dust-annual_growth-chart, fig.height=5, out.height=500}
