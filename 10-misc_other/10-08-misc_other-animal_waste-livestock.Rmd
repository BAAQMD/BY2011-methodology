## Animal Waste, Livestock {#misc_other-animal_waste-livestock}

```{r misc_other-animal_waste-livestock-setup}
THESE_CATEGORIES <- c(
...
#### Methodology {#misc_other-animal_waste-livestock-methodology -}

This methodology is presently based on ARB's methodology. Livestock population in the Bay Area was divided into subcategories: dairy cattle, range cattle, poultry (layers and broilers), swine, sheep, horses, and goats. Table \@ref(tab:misc-other-animal-waste-livestock-throughputs-table) shows livestock population in the Bay Area.

```{r misc-other-animal-waste-livestock-throughputs-table}
#' 
#' 1. Pull throughputs
...
The county distribution was based on the cattle population in Table \@ref(tab:misc-other-animal-waste-livestock-throughputs-table) for the nine counties.

#### History {-}

```{r misc_other-animal_waste-livestock-annual_emission-chart, fig.height=10, out.height=1000}
...
```{r misc_other-animal_waste-livestock-annual_growth-chart, fig.height=12, out.height=1200}
