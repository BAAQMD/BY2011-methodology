## Accidental Structural Fires {#misc_other-fires-struct}
...
#### Emission Factors {- #misc_other-fires-struct-emission_factors}
...
```{r misc-other-fires-struct-emission-factors-table}
