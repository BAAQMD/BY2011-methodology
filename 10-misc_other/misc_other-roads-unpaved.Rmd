...
```{r misc_other-roads-unpaved-setup}
THESE_CATEGORIES <- c(
...
```{r misc_other-roads-unpaved-annual_emission-chart, fig.height=6, out.height=600}
...
```{r misc_other-roads-unpaved-annual_growth-chart, fig.height=6, out.height=600}
