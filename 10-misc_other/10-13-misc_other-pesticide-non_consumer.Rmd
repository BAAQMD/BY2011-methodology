...
```{r misc_other-pesticide-non_consumer-setup}
THESE_CATEGORIES <- c(
...
```{r misc_other-pesticide-non_consumer-daily_emissions-table}
...
```{r misc_other-pesticide-non_consumer-annual_emissions-chart, fig.height=6, out.height=600}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r misc_other-pesticide-non_consumer-annual_growth-chart, fig.height=8, out.height=800}
