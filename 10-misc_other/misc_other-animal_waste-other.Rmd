...
```{r misc_other-animal_waste-other-setup}
THESE_CATEGORIES <- c(
...
```{r misc_other-animal_waste-other-annual_emission-chart, fig.height=6, out.height=600}
...
```{r misc_other-animal_waste-other-annual_growth-chart, fig.height=4, out.height=400}
