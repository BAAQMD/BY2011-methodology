## Accidental Vegetation Fires {#misc_other-fires-veg}

```{r misc_other-fires-veg-setup}
THESE_CATEGORIES <- c(
...
Emission factors and vegetation acreage consumed vary from fire season to fire season depending on type of vegetation consumed and weather conditions. For example, average composite emission factors and amounts of acreage burnt in the Bay Area by county are shown below for year 2008.

```{r misc-other-fires-veg-emission-factors-table}
...
```{r misc_other-fires-veg-throughputs-table}
BY2011_area_source_throughput_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  filter_years(
    CY(2008:2011)) %>% # FIXME: update for BY2015
  mutate(
...
```{r misc_other-fires-veg-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r misc_other-fires-veg-annual_growth-chart, fig.height=6, out.height=600}
