...
This methodology is presently based on ARB's methodology. Livestock population in the Bay Area was divided into subcategories: dairy cattle, range cattle, poultry (layers and broilers), swine, sheep, horses, and goats. \@ref(tab:misc-other-animal-waste-livestock-throughputs-table) shows livestock population in the Bay Area.
...
The county distribution was based on the cattle population in \@ref(tab:misc-other-animal-waste-livestock-throughputs-table) for the nine counties.
