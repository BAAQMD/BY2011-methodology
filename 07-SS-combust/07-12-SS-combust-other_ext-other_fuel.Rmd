...
```{r SS-combust-other-other-setup}
THESE_CATEGORIES <- c(
  "#308 LPG" = 308,
...
```{r SS-combust-other-other-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-other-other-growth-chart, fig.height=8, out.height=800}
...
```{r SS-combust-other-other-control-chart, fig.height=8, out.height=800}
