## Other External Combustion - All Other Fuels {#SS-combust-other_ext-other_fuel}

```{r SS-combust-other_ext-other_fuel-setup}
THESE_CATEGORIES <- c(
  "#308 LPG" = 308,
...
```{r SS-combust-other_ext-other_fuel-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-other_ext-other_fuel-growth-crosswalk}
...
```{r SS-combust-other_ext-other_fuel-growth-chart, fig.height=8, out.height=800}
...
```{r SS-combust-other_ext-other_fuel-control-chart, fig.height=8, out.height=800}
