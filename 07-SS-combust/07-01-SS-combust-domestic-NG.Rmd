...
```{r SS-combust-domestic_NG-emission-chart, fig.height=18, out.height=1800}
...
```{r SS-combust-domestic_NG-control-chart, fig.height=3, out.height=300}
...
The District adopted [Regulation 9-6] on April 1, 1992 to control the amount of NO~x~ emissions from natural gas fired water heaters. This rule has a control of 46% with a rule effectiveness of 94% reached by the year 2002.
