...
The residential natural gas consumption data by county for these categories was obtained from the California Energy Commission (CEC) consumption data base.  This total natural gas usage was broken down into each use category based on information from CEC and PG&E, and is shown below.
