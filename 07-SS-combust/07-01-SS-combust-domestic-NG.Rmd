...
```{r SS-combust-domestic_NG-setup}
THESE_CATEGORIES <- c(
...
```{r SS-combust-domestic_NG-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-domestic_NG-growth-chart, fig.height=6, out.height=600}
...
```{r SS-combust-domestic_NG-control-chart}
