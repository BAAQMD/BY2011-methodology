## Power Plants: Gas/Oil Turbines {#SS-combust-power_plant-turbines_and_distrib}

```{r SS-combust-power_plant-turbines_and_distrib-setup}
THESE_CATEGORIES <- c(
...
### Trends {#SS-combust-power_plant-turbines_and_distrib-trend}

#### History {-}

```{r SS-combust-power_plant-turbines_and_distrib-emission-chart, fig.height=14, out.height=1400}
...
```{r SS-combust-power_plant-turbines_and_distrib-growth-crosswalk}
...
```{r SS-combust-power_plant-turbines_and_distrib-growth-chart, fig.height=8, out.height=800}
...
```{r SS-combust-power_plant-turbines_and_distrib-control-chart}
...
The Bay Area Air District Regulation 9, Rule 9 controls NO~x~ and CO emissions from fuel combustion in gas turbines.
