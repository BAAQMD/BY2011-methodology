## Back-up Diesel Generator {#SS-combust-engines-crisis}
...
```{r SS-combust-engines-crisis-emission-chart, fig.height=8, out.height=800}
...
```{r SS-combust-engines-crisis-growth-crosswalk}
