...
```{r SS-combust-engines-recip-setup}
THESE_CATEGORIES <- c(
  "#302 Gasoline" = 302,
  "#303 Gas Fuel" = 303,
...
```{r SS-combust-engines-recip-emission-chart, fig.height=16, out.height=1600}
...
```{r SS-combust-engines-recip-growth-crosswalk}
...
```{r SS-combust-engines-recip-growth-chart, fig.height=6, out.height=600}
...
```{r SS-combust-engines-recip-control-chart, fig.height=8, out.height=800}
...
The Air District’s Regulation 9, Rule 8 controls NO~x~ and SO~x~ emissions of fuel combustion in reciprocating engines.
