## Power Plants - Gas/Oil Boilers {#SS-combust-power-boilers}

```{r SS-combust-power-boilers-setup}
THESE_CATEGORIES <- c(
...
### Trends {#SS-combust-power-boilers-trend}

#### Historical {-}

```{r SS-combust-power-boilers-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-power-boilers-BY-vs-DB-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r SS-combust-power-boilers-growth-crosswalk}
...
```{r SS-combust-power-boilers-growth-chart}
...
```{r SS-combust-power-boilers-control-chart, fig.height=8, out.height=800}
