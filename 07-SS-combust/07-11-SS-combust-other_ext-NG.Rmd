...
```{r SS-combust-NG-other-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-NG-other-growth-chart, fig.height=6, out.height=600}
...
```{r SS-combust-NG-other-control-chart, fig.height=6, out.height=600}
