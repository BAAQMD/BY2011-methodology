## Other External Combustion - Natural Gas {#SS-combust-other_ext-NG}

```{r SS-combust-other_ext-NG-setup}
THESE_CATEGORIES <- c(
...
```{r SS-combust-other_ext-NG-emfac-table}
...
```{r SS-combust-other_ext-NG-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-other_ext-NG-growth-crosswalk}
...
```{r SS-combust-other_ext-NG-growth-chart, fig.height=6, out.height=600}
...
```{r SS-combust-other_ext-NG-control-chart, fig.height=6, out.height=600}
