## Turbines {#SS-combust-turbines}

```{r SS-combust-turbines-setup}
THESE_CATEGORIES <- c(
...
### Trends {#SS-combust-turbines-trend}

#### History {-}

```{r SS-combust-turbines-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-turbines-BY-vs-DB-chart, fig.height=18, out.height=1800}
BY2011_annual_emission_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
...
```{r SS-combust-turbines-growth-chart, fig.height=8, out.height=800}
...
```{r SS-combust-turbines-growth-crosswalk}
...
```{r SS-combust-turbines-control-chart}
