...
```{r SS-combust-domestic-wood-emission-chart, fig.height=12, out.height=1200}
...
```{r SS-combust-domestic-wood-growth-chart, fig.height=8, out.height=800}
...
```{r SS-combust-domestic-wood-control-chart, fig.height=6, out.height=600}
