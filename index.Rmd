...
- **Tables** with footnotes, dynamic calculations, and values pulled directly from BY2011 data (examples: [Structural Coatings](#petprod-coat-struct-history), [Waste Burning](#waste-burn-planned_ag-methodology), [Accidental Fires](#misc-fire-struct-methodology), and [Animal Waste](#misc-animal-livestock-methodology));
