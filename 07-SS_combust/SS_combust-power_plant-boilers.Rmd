## Power Plants - Gas/Oil Boilers {#SS_combust-power_plant-boilers}

```{r SS_combust-power_plant-boilers-setup}
THESE_CATEGORIES <- c(
...
### Trends {SS_combust-power_plant-boilers-trend}

#### Historical {-}

```{r SS_combust-power_plant-boilers-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r SS_combust-power_plant-boilers-annual_growth-chart}
...
```{r SS_combust-power_plant-boilers-annual_control-chart, fig.height=8, out.height=800}
