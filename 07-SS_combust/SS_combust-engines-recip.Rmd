...
```{r SS_combust-engines-recip-setup}
THESE_CATEGORIES <- c(
  "#302 Gasoline" = 302,
  "#303 Gas Fuel" = 303,
...
```{r SS_combust-engines-recip-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r SS_combust-engines-recip-annual_growth-chart}
...
```{r SS_combust-engines-recip-annual_control-chart, fig.height=8, out.height=800}
...
The Air District’s Regulation 9, Rule 8 controls NOx and SOx emissions of fuel combustion in reciprocating engines.
