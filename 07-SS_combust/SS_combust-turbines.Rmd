...
```{r SS_combust-turbines-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r SS_combust-turbines-annual_growth-chart, fig.height=8, out.height=800}
...
```{r SS_combust-turbines-annual_control-chart}
...
The Air District’s Regulation 9, Rule 9 controls NOx and SOx emissions from fuel combustion in stationary turbines.
