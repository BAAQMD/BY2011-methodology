...
```{r SS_combust-engines-crisis-setup}
THESE_CATEGORIES <- c(
...
```{r SS_combust-engines-crisis-annual_emission-chart, fig.height=8, out.height=800}
...
```{r SS_combust-engines-crisis-annual_growth-chart}
