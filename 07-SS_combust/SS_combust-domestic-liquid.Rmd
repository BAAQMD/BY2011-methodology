...
```{r SS_combust-domestic-liquid-setup}
THESE_CATEGORIES <- c(
  "#286 LPG" = 286,
...
```{r SS_combust-domestic-liquid-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r SS_combust-domestic-liquid-annual_growth-chart}
