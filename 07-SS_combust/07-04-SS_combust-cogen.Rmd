...
```{r SS_combust-cogen-annual_emission-chart, fig.height=12, out.height=1200}
...
```{r SS_combust-cogen-annual_growth-chart, fig.height=8, out.height=800}
...
```{r SS_combust-cogen-annual_control-chart, fig.height=6, out.height=600}
