...
```{r waste_burn-incineration-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r waste_burn-incineration-annual_growth-chart, fig.height=4, out.height=400}
