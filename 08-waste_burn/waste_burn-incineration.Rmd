...
```{r waste_burn-incineration-setup}
THESE_CATEGORIES <- c(
...
```{r waste_burn-incineration-emission_factors-table}
...
```{r SS_combust-waste_burn-incineration-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r SS_combust-waste_burn-incineration-annual_growth-chart, fig.height=8, out.height=800}
