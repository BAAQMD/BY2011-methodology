## Planned Agricultural Burning {#waste_burn-planned_ag}
...
#### Methodologies {#waste_burn-planned_ag-methodology -}
...
```{r waste-burn-planned-ag-emission-factors-table}
...
```{r waste_burn-planned_ag-annual_emissions-chart, fig.height=12, out.height=1200}
...
```{r waste_burn-planned_ag-annual_growth-chart, fig.height=8, out.height=800}
