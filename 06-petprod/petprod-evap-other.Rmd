...
```{r petprod-evap-other-annual_emission-chart, fig.height=6, out.height=600}
...
```{r petprod-evap-other-annual_growth-chart}
...
```{r petprod-evap-other-annual_control_factor_data}
