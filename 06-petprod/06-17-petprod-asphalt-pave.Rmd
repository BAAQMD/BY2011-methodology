...
```{r petprod-asphalt-pave-annual_emission-chart}
...
```{r petprod-asphalt-pave-annual_growth-chart, fig.height=5, out.height=500}
...
```{r petprod-asphalt-pave-annual_control_factor_data}
