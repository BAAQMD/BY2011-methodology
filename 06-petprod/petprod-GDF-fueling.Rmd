...
```{r petprod-GDF-fueling-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r petprod-GDF-fueling-annual_growth-chart, fig.height=12, out.height=1200}
...
```{r petprod-GDF-fueling-annual_control-chart, fig.height=6, out.height=600}
