## Portable Fuel Container Spillage {#petprod-portable_spillage}

```{r petprod-portable_spillage-setup}
THESE_CATEGORIES <- c(
...
#### Methodology {- petprod-portable_spillage-methodology}
...
```{r petprod-portable_spillage-emission-chart}
...
```{r petprod-portable_spillage-growth-crosswalk}
...
```{r petprod-portable_spillage-growth-chart, fig.height=3, out.height=300}
...
```{r petprod-portable_spillage-control-chart, fig.height=3, out.height=300}
