...
- [Large Appliance & Metal Furniture](#coat-indcom-metal_part) (P/A)
- [Misc. Metal Parts & Small Appliance](#coat-indcom-small_appliance) (P/A) 
...
```{r coat-indcom-can_coil, child="coat-indcom-can_coil.Rmd"}
```

***

```{r coat-indcom-wood_furniture, child="coat-indcom-wood_furniture.Rmd"}
```

***

```{r coat-indcom-paper, child="coat-indcom-paper.Rmd"}
```

***

```{r coat-indcom-plastic_part, child="coat-indcom-plastic_part.Rmd"}
```

***

```{r coat-indcom-fabric_film, child="coat-indcom-fabric_film.Rmd"}
```

***

```{r coat-indcom-magnet_wire, child="coat-indcom-magnet_wire.Rmd"}
```

***

```{r coat-indcom-metal_part, child="coat-indcom-metal_part.Rmd"}
```

***

```{r coat-indcom-wood_panel, child="coat-indcom-wood_panel.Rmd"}
```

***

```{r coat-indcom-auto_assembly, child="coat-indcom-auto_assembly.Rmd"}
```

***

```{r coat-indcom-auto_refinish, child="coat-indcom-auto_refinish.Rmd"}
```

***

```{r coat-indcom-marine, child="coat-indcom-marine.Rmd"}
```

***

```{r coat-indcom-aero_assembly, child="coat-indcom-aero_assembly.Rmd"}
```

***

```{r coat-indcom-other, child="coat-indcom-other.Rmd"}
```
