## Gasoline Bulk Plant Storage Tanks

```{r petprod-bulk_term-tanks-setup}
THESE_CATEGORIES <- c(
...
```{r petprod-bulk_term-tanks-annual_emissions-chart}
...
```{r petprod-bulk_term-tanks-annual_growth-chart}
...
```{r petprod-bulk_term-tanks-annual_control-chart}
