...
```{r petprod-gasoline-truck_load-annual_emissions-chart}
...
```{r petprod-gasoline-truck_load-annual_growth-chart}
...
```{r petprod-gasoline-truck_load-annual_control-chart}
