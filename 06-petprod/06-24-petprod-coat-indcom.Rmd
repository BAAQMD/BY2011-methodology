...
- [Can and Coil](#coat-indcom-can_coil) (P)
- [Wood Furniture & Cabinet](#coat-indcom-mfg-wood_furniture) (P/A)
- [Paper Coating](#coat-indcom-paper) (P/A)
- [Fabric & Film](#coat-indcom-fabric_film) (P/A)
- [Plastic Parts & Product](#coat-indcom-plastic_part) (P/A)
- [Magnet Wire](#coat-indcom-magnet_wire) (P/A)
- [Large Appliance & Metal Furniture](#coat-indcom-large_appliance) (P/A)
- [Misc. Metal Parts & Small Appliance](#coat-indcom-metal_part) (P/A) 
- [Flat Wood Paneling](#coat-indcom-mfg-wood_panel) (P)
- [Motor Vehicle Assembly Plants](#coat-indcom-auto_assembly) (P/A) 
- [Auto Refinishing](#coat-indcom-auto_refinish) (P)
- [Marine Coating](#coat-indcom-marine) (P/A) 
- [Aerospace Assembly](#coat-indcom-aero_assembly) (P) 
- [Other Coatings](#coat-indcom-other) (P/A)
...
```{r coat-indcom-can_coil, child="06-petprod/06-24-petprod-coat-indcom/can_coil.Rmd"}
```

***

```{r coat-indcom-mfg-wood_furniture, child="06-petprod/06-24-petprod-coat-indcom/wood_furniture.Rmd"}
```
...
```{r coat-indcom-plastic_part, child="06-petprod/06-24-petprod-coat-indcom/plastic_part.Rmd"}
```

***

```{r coat-indcom-fabric_film, child="06-petprod/06-24-petprod-coat-indcom/fabric_film.Rmd"}
```

***

```{r coat-indcom-magnet_wire, child="06-petprod/06-24-petprod-coat-indcom/magnet_wire.Rmd"}
```

***

```{r coat-indcom-metal_part, child="06-petprod/06-24-petprod-coat-indcom/metal_part.Rmd"}
```

***

```{r coat-indcom-mfg-wood_panel, child="06-petprod/06-24-petprod-coat-indcom/wood_panel.Rmd"}
```

***

```{r coat-indcom-auto_assembly, child="06-petprod/06-24-petprod-coat-indcom/auto_assembly.Rmd"}
```

***

```{r coat-indcom-auto_refinish, child="06-petprod/06-24-petprod-coat-indcom/auto_refinish.Rmd"}
```
...
```{r coat-indcom-aero_assembly, child="06-petprod/06-24-petprod-coat-indcom/aero_assembly.Rmd"}
```
