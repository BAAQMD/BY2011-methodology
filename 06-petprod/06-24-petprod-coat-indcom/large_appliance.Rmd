...
```{r petprod-coat-indcom-large_appliance-annual_emissions-chart}
...
```{r petprod-coat-indcom-large_appliance-annual_emission_factor-chart}
...
```{r petprod-coat-indcom-large_appliance-annual_growth-chart, fig.height=6, out.height=600}
...
```{r petprod-coat-indcom-large_appliance-annual_control-chart}
...
```{r petprod-coat-indcom-large_appliance-BY_vs_DB-emissions_chart}
BY2011_annual_emission_data %>%
  filter_categories(
    LARGE_APPLIANCE_CATEGORIES) %>%
