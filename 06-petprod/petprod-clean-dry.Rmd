...
```{r petprod-clean-dry-annual_emission-chart}
...
```{r petprod-clean-dry-annual_growth-chart, fig.height=6, out.height=600}
...
```{r petprod-clean-dry-annual_control_factor_data, fig.height=6, out.height=600}
