...
```{r petprod-marine_load-growth-chart, fig.height=16, out.height=1600}
...
```{r petprod-marine_load-ballast_vent-control-chart}
BY2011_annual_control_factor_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  filter_categories(
...
```{r petprod-marine_load-barge_tanker-control-chart, fig.height=8, out.height=800}
BY2011_annual_control_factor_data %>%
  filter_categories(
    THESE_CATEGORIES) %>%
  filter_categories(
