## Vacuum Truck at Refinery, Marine, Bulk Terminals {#petprod-vacuum_truck}

```{r petprod-vacuum_truck-setup}
THESE_CATEGORIES <- c(
...
```{r petprod-vacuum_truck-emission-chart}
...
#### Growth {- #petprod-vacuum_truck-growth}

```{r petprod-vacuum_truck-growth-crosswalk}
...
```{r petprod-vacuum_truck-growth-chart, fig.height=3, out.height=300}
...
```{r petprod-vacuum_truck-control-chart, fig.height=3, out.height=300}
...
Vacuum truck is regulated under District’s Regulation 8, Rule 53 which established an emission limit that applies at the vapor exhaust outlet of the vacuum truck or associated equipment. The rule also establishes a limit for vapor leads and for liquid leaks from vacuum truck equipment.
