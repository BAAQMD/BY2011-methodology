...
```{r petprod-fueling-aircraft-annual_emissions-chart, fig.height=6, out.height=600}
...
```{r petprod-fueling-aircraft-annual_growth-chart, fig.height=8, out.height=800}
