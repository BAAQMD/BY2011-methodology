...
```{r petprod-adhesive_seal-emission-chart, fig.height=7, out.height=700}
...
```{r petprod-adhesive_seal-growth-growth-crosswalk}
...
```{r petprod-adhesive_seal-growth-chart, fig.height=5, out.height=500}
...
```{r petprod-adhesive_seal-control-chart}
