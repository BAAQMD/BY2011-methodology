...
```{r petprod-fueling-ship_boat-emission-chart, fig.height=6, out.height=600}
...
```{r petprod-fueling-ship_boat-growth-crosswalk}
...
```{r petprod-fueling-ship_boat-growth-chart, fig.height=8, out.height=800}
