...
Storage tanks at bulk plants and gasoline stations are inventoried in sections [6.4](#petprod-bulk_term-tanks) and [6.9](#petprod-GDF-storage), respectively.
...
```{r petprod-petref-storage-annual_growth-chart, fig.height=14, out.height=1400}
...
```{r petprod-petref-storage-annual_control-chart, fig.height=14, out.height=1400}
